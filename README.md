[![Coverage Status](https://coveralls.io/repos/github/Stratio/scala-cross-build-maven-plugin/badge.svg?branch=branch-0.1)](https://coveralls.io/github/Stratio/scala-cross-build-maven-plugin?branch=branch-0.1)
